...
void Intersection::addVehicleToQueue(std::shared_ptr<Vehicle> vehicle)
{
    ...
    // DONE: FP.6b : use the methods TrafficLight::getCurrentPhase and TrafficLight::waitForGreen to block the execution 
...
{
    // DONE: FP.6a : In Intersection.h, add a private member _trafficLight of type TrafficLight. 
